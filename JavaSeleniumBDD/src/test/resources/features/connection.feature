...
Scenario: open http://52.150.10.52:3000/
    Given loads browser to check image
    When user navigates to http://52.150.10.52:3000/
    Then user sees element image1
    Then user takes a screenshot

Scenario: open http://52.150.10.52:3000/ to check link1
    Given loads browser to check link1
    When user navigates to http://52.150.10.52:3000/ 
    Then user sees element link1
    Then user takes a screenshot of link1

Scenario: open http://52.150.10.52:3000/ to check link2
