...
Scenario: open http://52.188.63.194:3000/ to check h1
    Given user loads browser
    When user navigates to http://52.188.63.194:3000/
    Then user sees element h1
    Then user takes a screenshot

Scenario: open http://52.188.63.194:3000/ to check 'The Homelander' in hero list
    Given user loads browser
...
Scenario: open http://52.188.63.194:3000/ to get 'The Homelander' value in Textbox
    Given user loads browser
    When user navigates to http://13.92.244.119:3000/ 
